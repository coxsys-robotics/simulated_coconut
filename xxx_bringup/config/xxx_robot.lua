...
options = {
  ...
  num_point_clouds = 0,
  lookup_transform_timeout_sec = 0.2, --0.5
...
MAP_BUILDER.num_background_threads = 3 --7
...
TRAJECTORY_BUILDER_2D.min_range = 0.15 --0.15
TRAJECTORY_BUILDER_2D.max_range = 6.0 --6.0
